...
function DonationForm({ setConfirmationData }) {
  ...
  const clothingTypes = [
    "Kleidung (z.B. warme Jacken, Pullover, Hosen)",
    "Decken und Schlafsäcke",
    "Hygieneartikel (z.B. Zahnbürsten, Zahnpasta, Seife)",
    "Lebensmittel (nicht verderbliche, haltbare Lebensmittel)",
    "Trinkwasser",
    "Medikamente und Verbandsmaterial",
    "Babyartikel (z.B. Windeln, Babynahrung)",
    "Sanitärartikel für Frauen (z.B. Tampons, Damenbinden)",
    "Haushaltsartikel (z.B. Geschirr, Besteck, Töpfe)",
    "Hygieneartikel für Haustiere (z.B. Tierfutter, Streu)",
    "Batterien und Taschenlampen",
    "Kommunikationsgeräte (z.B. Handys mit Ladegeräten)",
    "Spielzeug und Bücher (insbesondere für Kinder)",
    "Kochutensilien (z.B. Campingkocher, Töpfe)",
    "Karten oder Bargeldspenden für spezifische Bedürfnisse",
  ];
  const crisisAreas = [
    "Ukraine",
    "Syrien",
